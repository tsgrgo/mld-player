...
export interface SamplerInstance {
	 ...
	 */
	keyOn(channel: number, key: number, velocity: number): void;
	 ...
	 */
	panpot(channel: number, panpot: number): void;
	 ...
	 */
	volume(channel: number, volume: number): void;
}
